...
@media (min-width: 1025px) {
  .single-product .powerup-pdp-media-stack > .powerup-amz-gallery {
    ...
    margin-left: clamp(24px, 3vw, 36px) !important;
  }
  .single-product .powerup-pdp-media-stack > .powerup-amz-gallery .powerup-amz-main {
    height: clamp(520px, 52vw, 680px) !important;
    min-height: 520px !important;
    max-height: 680px !important;
  }
  .single-product .powerup-pdp-media-stack > .powerup-amz-gallery .powerup-amz-main-image {
